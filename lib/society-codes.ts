...
// 💡 [삭제] checkSocietyCodeAnalysisQuota / SOCIETY_CODE_MONTHLY_ANALYSIS_LIMIT(월 100회)는
// 등급별 월 토큰 한도(lib/plan-limits.ts의 MONTHLY_TOKEN_LIMITS.code)로 대체됐습니다.
// 같은 "1회"가 182토큰일 수도 534,676토큰일 수도 있어 횟수로는 실제 부담을 전혀 반영하지
// 못했습니다. 코드 기반 Pro의 차단은 이제 lib/token-safety.ts가 담당합니다.
